...
CREATE TABLE `a_ad_item`  (
  ...
  `ad_space_id` int NULL DEFAULT NULL,
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '广告名称',
  `object_id` int NULL DEFAULT NULL,
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
  `content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '内容',
  `weight` double NULL DEFAULT 0 COMMENT '权重',
  `create_admin` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `a_ad_space`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '广告名称',
  `no` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '广告编号',
  `template` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '模板内容',
  `number` int NULL DEFAULT NULL COMMENT '容量',
  `type` tinyint NULL DEFAULT NULL COMMENT '类型',
  `width` int NULL DEFAULT NULL COMMENT '图片',
...
CREATE TABLE `o_gateway_order`  (
  ...
  `gateway_trade_no` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `o_logistic`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '公司名称',
  `code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '快递公司代码',
  `company_url` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '公司网址',
  `weight` double NULL DEFAULT NULL COMMENT '排序',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `o_order`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `no` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单号',
  ...
  `total_quantity` int NULL DEFAULT NULL COMMENT '订单数量',
  `consumer_user_id` int NULL DEFAULT NULL,
  `consignee_tel` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人电话',
  `consignee_cellphone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人手机',
  `consignee_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人姓名',
  `consignee_address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人地址',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '下单时间',
  `pay_time` datetime NULL DEFAULT NULL COMMENT '支付时间',
  `logisticid` int NULL DEFAULT NULL COMMENT '快递',
  `logistic_no` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '快递单号',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `no`(`no` ASC) USING BTREE,
...
CREATE TABLE `o_order_item`  (
  ...
  `message` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '留言',
  `snapshot_id` int NULL DEFAULT NULL COMMENT '商品快照',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单名称',
  `pic_url` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品图片url',
  `product_id` int NULL DEFAULT NULL COMMENT '商品ID',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_t_order_t_snapshot`(`snapshot_id` ASC) USING BTREE
...
CREATE TABLE `o_refund_apply`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NULL DEFAULT NULL COMMENT '单订号',
  `amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '退款金额',
  `reason` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退款原因',
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
  `create_time` datetime NULL DEFAULT NULL,
  `reply` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '理员管回复',
  `reply_time` datetime NULL DEFAULT NULL,
  `replay_admin_id` int NULL DEFAULT NULL,
  `pics` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `p_category`  (
  ...
  `leaf` bit(1) NULL DEFAULT NULL COMMENT '是否是叶子',
  `weight` double NULL DEFAULT NULL COMMENT '排序',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `create_admin` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `p_category` VALUES (234, 233, '视频广告', '', b'1', 1, '2020-10-21 14:20:06', 'admin');
INSERT INTO `p_category` VALUES (235, 233, '杂志', '', b'1', 1, '2020-10-21 14:20:40', 'admin');
INSERT INTO `p_category` VALUES (236, 233, '报纸', '', b'1', 5, '2020-10-21 14:20:51', 'admin');
INSERT INTO `p_category` VALUES (240, 233, 'ggg', 'gggg', b'0', 222, '2020-11-03 14:52:23', 'admin');
INSERT INTO `p_category` VALUES (244, 237, 'fhfgh', 'fghgfh', b'1', 6, '2020-11-03 14:58:44', 'admin');
INSERT INTO `p_category` VALUES (245, 237, 'kjkh', 'hjk', b'1', 7, '2020-11-03 15:00:29', 'admin');
INSERT INTO `p_category` VALUES (251, 237, '32', '323', b'0', 3232, '2020-11-03 16:50:28', 'admin');
INSERT INTO `p_category` VALUES (252, 237, '1212', '2121', b'0', 212, '2020-11-03 16:50:49', 'admin');
INSERT INTO `p_category` VALUES (255, 251, 'fgfg', 'dfgdg', b'1', 45, '2020-11-03 17:04:02', 'admin');
INSERT INTO `p_category` VALUES (257, 251, 'tertiary', '2323', b'1', 333, '2020-11-03 17:21:14', 'admin');
INSERT INTO `p_category` VALUES (263, 251, 'llk', 'lk', b'1', 8, '2020-11-03 17:44:14', 'admin');
INSERT INTO `p_category` VALUES (265, 251, 'uytyu', 'tutyu', b'1', 7, '2020-11-03 17:45:42', 'admin');
INSERT INTO `p_category` VALUES (266, 251, 'dfgsfg', 'dfgsfdg', b'1', 4, '2020-11-03 17:45:57', 'admin');
INSERT INTO `p_category` VALUES (267, 251, 'hhhg', 'ffg', b'1', 5, '2020-11-04 16:47:59', 'admin');
INSERT INTO `p_category` VALUES (268, -1, '口罩', '', b'1', 1, '2023-04-08 22:45:42', 'admin');
...
CREATE TABLE `p_evaluation`  (
  ...
  `agree` int NULL DEFAULT 0 COMMENT '认为此评价有用人数',
  `product_id` int NULL DEFAULT NULL,
  `time` datetime NULL DEFAULT NULL,
  `attitude_score` double(2, 1) NULL DEFAULT NULL COMMENT '服务态度得分',
  `describe_score` double(2, 1) NULL DEFAULT NULL COMMENT '描述相符得分',
  `speed_score` double(2, 1) NULL DEFAULT NULL COMMENT '发货速度得分',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `p_product`  (
  ...
  `main_pic` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主图',
  `pic_filenames` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '轮播图',
  ...
  `create_admin` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
  `category_id` int NULL DEFAULT NULL COMMENT '分类',
  `all_category_ids` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '所有的分类id',
  `stock` int NULL DEFAULT NULL COMMENT '库存',
  `sales_num` int NULL DEFAULT 0 COMMENT '销量',
  `virtual_sales_num` int NULL DEFAULT 0 COMMENT '虚拟销量',
  `evaluation_num` int NULL DEFAULT 0 COMMENT '评价数量',
  `evaluation_score` double(3, 2) NULL DEFAULT 0.00 COMMENT '商品评价的总平均分',
  `properties` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `note` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备用字段',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `p_product` VALUES (1, '医用口罩', '/mall/product/1/image/2023-04-08/1680965227079.png', '/mall/product/1/image/2023-04-08/1680965227079.png', 1.00, 1.50, 0.50, '2023-04-08 22:47:54', 'admin', 2, 268, '268', 1000, 0, 800, 0, 0.00, NULL, NULL, '2023-04-08 22:49:54');
...
INSERT INTO `p_product_detail` VALUES (10, 1, '<p>必备居家物资</p>');
...
CREATE TABLE `p_property`  (
  ...
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '属性名',
  `property_values` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1768 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `s_admin`  (
  ...
  `real_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
-- Records of s_admin
-- ----------------------------
INSERT INTO `s_admin` VALUES (2, 'admin', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, '超级管理员', '2013-03-17 22:30:31', '2023-04-08 22:44:35', '2', 1, '2023-04-08 22:44:34');
...
CREATE TABLE `s_admin_login_record`  (
  ...
  `admin_user_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户名',
  `ip` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '登录时间',
...
INSERT INTO `s_admin_login_record` VALUES (21, 2, 'admin', '0:0:0:0:0:0:0:1', '2023-04-08 22:44:02', 'Windows 10', 'Computer', 'Chrome 11');
INSERT INTO `s_admin_login_record` VALUES (22, 2, 'admin', '0:0:0:0:0:0:0:1', '2023-04-08 22:44:35', 'Windows 10', 'Computer', 'Chrome 11');
...
CREATE TABLE `s_permission`  (
  ...
  `code` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '权限值',
  `icon` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图标',
  `type` tinyint NULL DEFAULT NULL COMMENT '权限类型：1->菜单；2->按钮（接口绑定权限）',
  `href` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '前端资源路径',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `weight` double(5, 2) NULL DEFAULT NULL COMMENT '排序',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户权限表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `s_role`  (
  ...
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_admin` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `s_role_permission`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 805 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户角色和权限关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `u_consignee_info`  (
  ...
  `cellphone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `postcode` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_id` int NULL DEFAULT NULL,
  `default_use` tinyint(1) NULL DEFAULT 0 COMMENT '是否为默认收货地址',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `u_favorite`  (
  ...
  `pic_url` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `u_open_user`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `openid` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `nickname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` timestamp NULL DEFAULT NULL,
  `user_info` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_id` int NULL DEFAULT NULL,
  `type` tinyint NULL DEFAULT NULL,
  `access_token` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `u_session_token`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `session_token` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `user_id` int NOT NULL,
  `remote_address` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
...
) ENGINE = MyISAM AUTO_INCREMENT = 279 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `u_user`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `username` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '用户名',
...
-- Records of u_user
-- ----------------------------
INSERT INTO `u_user` VALUES (72, 'admin', '123@qq.com', '4297f44b13955235245b2497399d7a93', 1, 1, '2013-10-10 19:40:38', '2013-07-08 21:11:33');
